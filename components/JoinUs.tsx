        ...
        <section className='flex flex-col px-10'>
            ...
            <div className='flex flex-col self-center mt-8 sm:mt-64 md:mt-80 xl:mt-96 2xl:mt-48'>
                <div className='flex w-72 self-center'>
                    <div className='bg-local w-full'><Image src={navItem['image-kita-satu']} alt='kita-satu' height='25' width='100%' layout='responsive' objectFit='contain' className="-z-10" /></div>
                </div>
